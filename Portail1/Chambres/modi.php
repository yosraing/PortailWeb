  ...
  <a href="../Session/logout.php">Logout</a>
    ...
    <main>
        <section class="well well__offset-3">
            <div class="container">
                <h2><em>Modifier une Chambre</em></h2>
...
$sql = "SELECT * FROM chambre where numeroChambre=$idurl";
...
if ($result->num_rows > 0) {
     ...
     while($row = $result->fetch_assoc()) {
         ...
         echo'<form method="POST" name="frmupload" action="modifier.php?ID='.$row["numeroChambre"].'" enctype= "multipart/form-data" >';
           echo'  <legend class="legend">Modifier chambre</legend>';
         echo"  <div class='input'>";
         echo"<center>";
       print "<img   width=100  src=".$row[mageChambre].">";  
       echo"</center>"; 
    ...
    //echo '<img height="42" width="42" src="data:image/jpeg;base64,'.base64_encode( $row["imageP"]).'"/>';
          echo "<br> Type chambre: <input type='text'  name ='typeC' value='". $row["typeChambre"]. " '/><br>
        Prix chambre : <input type='text' name='prix'value='" . $row["prixChambre"] . "'/> 
          <br>
          Description chambre : <input type='text' name='description'value='" . $row["description"] . "'/> 
";
...
<input type='submit' class='btn'  name='envoyer'  value='Modifier cette chambre'>
    <!--========================================================
                              FOOTER
    =========================================================-->
    <footer>
