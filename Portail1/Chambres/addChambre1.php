...
<head>
    ...
    <link rel="stylesheet" href="../css/style.cssqsel <link id="bs-css" href="css/bootstrap-cerulean.min.css" rel="stylesheet">
  ...
  <a href="../Session/logout.php">Logout</a>
    ...
    <main>
        <section class="well well__offset-3">
            <div class="container">
                <h2><em>Ajouter Chambre</em></h2>
 <form method="POST" name="frmupload" action="addChambre.php" enctype= "multipart/form-data" >
    <legend class="legend">Ajouter Chambre</legend><br>
<center>

<!-- <input type="text" name="id" size="20" value="id" maxlength="35"> -->
Image chambre :<input type="file"  name="pic" multiple="multiple"/><br/><br/>
 
 <div class='input'>
 <br>
 
 <input type="hidden" name="idP" size="20" maxlength="35"><br>
Type de la Chambre : <input type="text" name="nomC" size="20" maxlength="35"><br>
Prix de la chambre : <input type="text" name="prix" ><br>
Desciption de la chambre : <input type="text" name="description" size="20"  maxlength="70"><br> 
...
<input type="submit"  class="btn-mod" value="Envoyer" name="envoyer">
