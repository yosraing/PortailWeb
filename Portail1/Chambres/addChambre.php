  ...
  <a href="../Session/logout.php">Logout</a>
    ...
    <main>
        <section class="well well__offset-3">
            <div class="container">
                <h2><em>Chambre ajoutée</em></h2>
 
<script type="text/javascript">
function hello()
{ 
document.location.href="listeChambres.php" 
}
</script>
...
if(isset($_POST['nomC']))      $nomC=$_POST['nomC'];
else      $nomC="";
...
$value=mysql_real_escape_string($typeP);
 //print_r($image);
$sql = "INSERT INTO chambre(typeChambre, prixChambre, description, idHotel,imageChambre) VALUES ('$nomC', '$prix', '$description','$idHotel','$nom')";
