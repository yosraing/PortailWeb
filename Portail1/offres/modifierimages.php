...
document.location.href="addOffres.php" 
...
<li>   <a href="../ForumAdmin/Forum.php">Forum</a>
                    </li>
...
$idurl = $_GET['ID']; 
$sql = "UPDATE Offre SET imageOffre='$nom' WHERE idOffre=$idurl";
