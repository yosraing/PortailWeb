...
$sql = "UPDATE Offre SET nomOffre='$nomP', dateDebut='$dateDebPro', dateFin='$dateFin',prixAncien='$prixAncien',prixNouveau='$prixNouveau',description='$desP',idHotel='$idHotel' WHERE idOffre=$idurl";
