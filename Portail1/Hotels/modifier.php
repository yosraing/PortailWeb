...
if(isset($_POST['nomHotel']))      $nomHotel=$_POST['nomHotel'];
else      $nomHotel="";

if(isset($_POST['nbrEtoile']))      $nbrEtoile=$_POST['nbrEtoile'];
else      $nbrEtoile="";
...
$sql = "UPDATE hotels SET nomHotel='$nomHotel', nbrEtoile='$nbrEtoile', emplacement='$Emplacement',description='$desP' WHERE idHotel=$idurl";
