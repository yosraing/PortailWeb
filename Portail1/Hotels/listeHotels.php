...
document.location.href="addHotel1.php" 
...
<div class="wrap">
    ...
    <a class="btn-7" href="addHotel1.php"><span>Ajouter une promotion</span></a>
...
echo" <a class='btn-mod' href='modi.php?ID=".$row['idHotel']."'><span>Modifier hotel</span></a>";


echo" <a class='btn-mod'  href='images.php?ID=".$row['idHotel']."'><span>Modifier l'image</span></a>";
echo" <a class='btn-mod' href='sup.php?ID=".$row['idHotel']."'><span>Supprimer hotel</span></a>";
