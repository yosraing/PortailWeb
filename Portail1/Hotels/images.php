...
<p align="right">
 ...
 echo'Modifier Image hotel :<input type="file"  name="pic" multiple="multiple"/><br/>';
 echo "<input type='submit' class='btn'  name='envoyer'  value='Modifier cette image de l'hotel>";
