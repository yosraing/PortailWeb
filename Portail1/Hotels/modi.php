...
$sql = "SELECT * FROM hotels where idHotel=$idurl";
...
if ($result->num_rows > 0) {
     ...
     while($row = $result->fetch_assoc()) {
         ...
         echo'<form method="POST" name="frmupload" action="modifier.php?ID='.$row["idHotel"].'" enctype= "multipart/form-data" >';
           echo'  <legend class="legend">Modifier hotel</legend>';
         echo"  <div class='input'>";
         echo"<center>";
       print "<img   width=100  src=".$row[imageHotel].">";  
       echo"</center>"; 
    ...
    //echo '<img height="42" width="42" src="data:image/jpeg;base64,'.base64_encode( $row["imageP"]).'"/>';
          echo "<br> Nom hotel: <input type='text'  name ='nomHotel' value='". $row["nomHotel"]. " '/><br>
          
         

          Emplacement: <input type='text' name='Emplacement'value='" . $row["emplacement"] . "'/> 
...
<input type='submit' class='btn'  name='envoyer'  value='Modifier cet hotel'>
    <!--========================================================
                              FOOTER
    =========================================================-->
    <footer>
