...
<div class="wrap">
    ...
    <a class="btn-7" href="addPromotion1.php"><span>Ajouter une promotion</span></a>
...
$sql = "SELECT Promotion.idPromotion,Promotion.nomPromotion,Promotion.dateDebut,Promotion.dateFin,Promotion.prixAncien,Promotion.prixNouveau,Promotion.description,Promotion.idHotel,Promotion.imagePromotion, hotels.nomHotel FROM Promotion,hotels where Promotion.idHotel=hotels.idHotel";
...
echo"<tr >";
        ...
        echo"<td>". $row["nomHotel"]."</td>";
         echo '<td>  '. $row["nomPromotion"]. ' </td><td>  '. $row["dateDebut"]. ' </td><td> ' . $row["dateFin"] . '</td><td> ' . $row["prixAncien"] .'</td><td>' . $row["prixNouveau"] .'</td>';
...
echo" <a class='btn-mod' href='modi.php?ID=".$row['idPromotion']."'><span>Modifier promotion</span></a>";


echo" <a class='btn-mod' ref='images.php?ID=".$row['idPromotion']."'><span>Modifier l'image</span></a>";
echo" <a class='btn-mod' href='sup.php?ID=".$row['idPromotion']."'><span>Supprimer promotion</span></a>";
