  ...
  <a href="../Session/logout.php">Logout</a>
    ...
    <main>
        <section class="well well__offset-3">
            <div class="container">
                <h2><em>Ajouter promotion</em></h2>
 <form method="POST" name="frmupload" action="addPromotion.php" enctype= "multipart/form-data" >
    <legend class="legend">Ajouter Promotion</legend><br>
<center>

<!-- <input type="text" name="id" size="20" value="id" maxlength="35"> -->
Image Promotion :<input type="file"  name="pic" multiple="multiple"/><br/><br/>
 
 <div class='input'>
 <br>
 
 <input type="hidden" name="idP" size="20" maxlength="35"><br>
Nom de la promotion : <input type="text" name="nomP" size="20" maxlength="35"><br>
Description de la romotion : <input type="text" name="description" ><br>
Prix ancien de la promotion : <input type="text" name="prixAncien" size="20"  maxlength="70"><br> 
Prix nouveau de la promotion : <input type="text" name="prixNouveau" size="20"  maxlength="70"><br> 
Date Debut de la promotion : <input type="text" name="dateDebut" size="20"  maxlength="70"><br> 
Date fin de la promotion : <input type="text" name="dateFin" size="20"  maxlength="70"><br> 
