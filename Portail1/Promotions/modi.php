  ...
  <a href="../Session/logout.php">Logout</a>
    ...
    <main>
        <section class="well well__offset-3">
            <div class="container">
                <h2><em>Modifier une promotion</em></h2>
...
$sql = "SELECT * FROM Promotion where idPromotion=$idurl";
...
if ($result->num_rows > 0) {
     ...
     while($row = $result->fetch_assoc()) {
         ...
         echo'<form method="POST" name="frmupload" action="modifier.php?ID='.$row["idPromotion"].'" enctype= "multipart/form-data" >';
           echo'  <legend class="legend">Modifier promotion</legend>';
         echo"  <div class='input'>";
         echo"<center>";
       print "<img   width=100  src=".$row[imagePromotion].">";  
       echo"</center>"; 
    ...
    //echo '<img height="42" width="42" src="data:image/jpeg;base64,'.base64_encode( $row["imageP"]).'"/>';
          echo "<br> Nom Promotion: <input type='text'  name ='nomP' value='". $row["nomPromotion"]. " '/><br>
...
<input type='submit' class='btn'  name='envoyer'  value='Modifier cette promotion'>
    <!--========================================================
                              FOOTER
    =========================================================-->
    <footer>
