...
$value=mysql_real_escape_string($typeP);
 //print_r($image);
$sql = "INSERT INTO Promotion (nomPromotion, dateDebut, dateFin,prixAncien,prixNouveau,description,idHotel, imagePromotion) VALUES ('$nomP', '$dateDebPro', '$dateFinPro','$prixAP','$prixNP','$desP', '$idHotel', '$nom')";
